...
const Navbar = () => {
  ...
  return (
    ...
    <nav className="bg-brand-contrast dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
      ...
      <div className="bg-brand-contrast flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
