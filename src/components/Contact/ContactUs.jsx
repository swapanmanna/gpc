...
//                                     </div>
//                                     <div className="flex gap-2">
//                                         <div className="mb-2 w-full"> {/* Added w-full */}
//                                             <input
//                                                 type="text"
//                                                 placeholder="Email"
//                                                 className="border border-gray-300 shadow dark:border-dark-3 dark:text-dark-6 dark:bg-dark text-body-color placeholder-gray-500 focus:border-brand-gray w-full rounded-md border py-3 px-[14px] text-base outline-none"
...
//                                         </div>
//                                     </div>
//                                     <div className="flex gap-2"> {/* Added company and designation placeholders based on previous context */}
...
//                                     {/* Courses Interested In Checkboxes - Structure Only */}
