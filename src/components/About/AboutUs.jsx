...
//                 canonicalUrl="https://globalprofessionalcertifications.com/about"
//             />
//             <section className="bg-brand-blue py-12 sm:py-16 lg:py-20 relative md:min-h-[80vh] md:flex md:justify-center md:items-center">
...
//                                 <h2 className="text-gray-50 text-lg sm:text-2xl md:text-3xl lg:text-4xl font-bold font-manrope leading-tight lg:text-start text-center">
